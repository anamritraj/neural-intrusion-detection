...
src="evil.com/code.js">
	...
	\label{sec:nn-based-ids}
		...
		Each connection summary is described using 41 features which the Neural Network classifier uses as inputs for both training and testing. In the test dataset, each sample is similarly a connection summary, and there are a
		...
		\subsection{Implementations}
			...
			performed randomly. A separate test dataset was used to test the Neural Network.
			...
			added to the Neural Network output vector as a placeholder for the unknown outcome type. The
